...
var p = new PersonDD("Ray");
p.greet();
function loggedMethod(headMessage) {
    if (headMessage === void 0) { headMessage = "LOG:"; }
    return function actualDecorator(originalMethod, context) {
        ...
        function replacementMethod() {
            ...
            console.log("".concat(headMessage, " Entering method '").concat(methodName, "'."));
            var result = originalMethod.call.apply(originalMethod, __spreadArray([this], args, false));
            console.log("".concat(headMessage, " Exiting method '").concat(methodName, "'."));
            return result;
        }
...
var CalculatorGG = /** @class */ (function () {
    function CalculatorGG() {
    }
    //@log
    CalculatorGG.prototype.add = function (a, b) {
        return a + b;
    };
    return CalculatorGG;
}());
var calculatorD = new CalculatorGG();
calculatorD.add(1, 2);
